        ...
        <section className="py-12 md:py-16 px-6 md:px-8 lg:px-10 bg-black">
          <div className="flex flex-col justify-center items-center text-center mx-auto max-w-6xl gap-6 md:gap-10">
            ...
            <p className="font-sans text-sm md:text-md lg:text-lg leading-relaxed text-balance uppercase">
              ...
              experience. Through the custom-made service, discerning clients
              can create a one of a kind garment through a private appointment.
              The master tailors at the KIMHAB ORK Atelier devote weeks of
            ...
            <div className="space-y-8">
              <div className="flex gap-6">
                ...
                <div className="pb-8">
                  ...
                  <p className="text-white/90">
                    ...
                    discuss your vision and preferences. This typically takes
                    1-2 hours.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div className="pb-8">
                  ...
                  <p className="text-white/90">
                    Finalize your design and have precise measurements taken.
                    Our tailors use these to create your custom pattern and
                    foundation.
                  </p>
                </div>
              </div>
              ...
              <div className="flex gap-6">
                ...
                <div className="pb-8">
                  ...
                  <p className="text-white/90">
                    ...
                    multiple fittings scheduled to ensure absolute perfection
                    and fit.
                  </p>
                </div>
              </div>
            ...
            <div className="space-y-8">
              <div className="bg-muted/30 p-8 rounded-lg border border-border/40">
                <p className="text-lg text-white/80 italic mb-4 text-balance">
                  ...
                  expertise of true artisans. I feel like a different woman when
                  I wear it."
                </p>
